// El corazón de la app: LibroFamiliar (componente raíz, maneja todo el
// estado y el guardado) y las tres pantallas grandes que arma: AhorrosSection,
// PersonColumn ("Mi cuenta") y HogarSection ("Hogar — gastos compartidos").
import React, { useState, useEffect, useCallback } from "react";
import { ChevronLeft, ChevronRight, RotateCcw, AlertTriangle, PiggyBank, Plus, Trash2, Pencil, Check, ArrowDownCircle, ArrowUpCircle, CreditCard, TrendingUp } from "lucide-react";
import { MESES, CATEGORIAS, PERSONAS, fmt, IMPORT_AGOSTO_2026, PCT_DEFAULT, ETIQUETAS_TARJETA_DEFAULT, monthKey, monthLabel, shiftMonth, monthDiff } from "./constants.js";
import { storageSetRetry, fetchCotizacionLive } from "./storage.js";
import { FijosSection, Shell, TarjetasSection, CategoryDots, EtiquetasTarjetaPicker, TarjetasHogarSection, CotizacionWidget, budgetsFrom, RowEntry } from "./components.js";
...
function PersonColumn({
  ...
  function save() {
    onSave({
      pct: Object.fromEntries(CATEGORIAS.map(c => [c.id, Number(draft.pct[c.id]) || 0]))
    });
    setEditing(false);
  }
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    }, "= ", fmt(draftBudgets[c.id])), /*#__PURE__*/React.createElement("input", {
